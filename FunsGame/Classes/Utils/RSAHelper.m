...
//
//
//- (void)generatePemWithMoAndExXML:(NSString *)xmlStr
//{
...
//    
//    [self generatePemWithMo:moElement.stringValue ex:exElement.stringValue];
//}
//
//- (void)generatePemWithMo:(NSString *)b64Mo ex:(NSString *)b64Ex
//{
