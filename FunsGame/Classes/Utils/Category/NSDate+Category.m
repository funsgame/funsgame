...
- (NSUInteger)datagetHeight
{
    NSUInteger weekday = [[self firstDayOfCurrentMonth] weeklyOrdinality];

    NSUInteger days = [self numberOfDaysInCurruntMonth];
    NSUInteger weeks = 0;
...
//首先需要知道这个月有多少天
- (NSUInteger)numberOfDaysInCurruntMonth
{
...
{
    NSInteger k = [[NSCalendar currentCalendar]ordinalityOfUnit:NSDayCalendarUnit inUnit:NSWeekCalendarUnit forDate:self];
    return k;
}
