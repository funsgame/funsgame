...
- (id)initWithFrame:(CGRect)frame {
    ...
    if ((self = [super initWithFrame:frame])) {
        ...
        if ([[UIImage class] instancesRespondToSelector:@selector(imageWithRenderingMode:)]) {
          SVProgressHUDSuccessImage = [[UIImage imageWithName:@"SVProgressHUD.bundle/success"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
          SVProgressHUDErrorImage = [[UIImage imageWithName:@"SVProgressHUD.bundle/error"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
        } else {
          SVProgressHUDSuccessImage = [UIImage imageWithName:@"SVProgressHUD.bundle/success"];
          SVProgressHUDErrorImage = [UIImage imageWithName:@"SVProgressHUD.bundle/error"];
        }
...
- (CAShapeLayer*)indefiniteAnimatedLayer {
    if(!_indefiniteAnimatedLayer) {
        ...
        maskLayer.contents = (id)[[UIImage imageWithName:@"SVProgressHUD.bundle/angle-mask@2x.png"] CGImage];
