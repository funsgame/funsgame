...
{
	int innerDiameter = viewSize.width - self.theme.thickness + 8;
    float innerRadius = innerDiameter / 2;
...
//    self.label.text = [NSString stringWithFormat:@"%.0f", percentageCompleted];
    ...
    if(percentageCompleted == 100.0f)
        self.label.font = kFontSize12;
    else
        self.label.font = kFontSize15;
    self.label.textColor = kJHSColorRed;
	self.label.text = [NSString stringWithFormat:@"%.0f%%", percentageCompleted];
